...
public class MapleModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators blockStateModelGenerator) {
        ...
        BlockModelGenerators.BlockFamilyProvider lightBlue = blockStateModelGenerator.family(Blocks.LIGHT_BLUE_STAINED_GLASS);
        ...
        BlockModelGenerators.BlockFamilyProvider lightGray = blockStateModelGenerator.family(Blocks.LIGHT_GRAY_STAINED_GLASS);
        ...
        //Concrete
        BlockModelGenerators.BlockFamilyProvider whiteConcrete = blockStateModelGenerator.family(Blocks.WHITE_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider orangeConcrete = blockStateModelGenerator.family(Blocks.ORANGE_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider magentaConcrete = blockStateModelGenerator.family(Blocks.MAGENTA_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider lightBlueConcrete = blockStateModelGenerator.family(Blocks.LIGHT_BLUE_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider yellowConcrete = blockStateModelGenerator.family(Blocks.YELLOW_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider limeConcrete = blockStateModelGenerator.family(Blocks.LIME_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider pinkConcrete = blockStateModelGenerator.family(Blocks.PINK_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider grayConcrete = blockStateModelGenerator.family(Blocks.GRAY_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider lightGrayConcrete = blockStateModelGenerator.family(Blocks.LIGHT_GRAY_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider cyanConcrete = blockStateModelGenerator.family(Blocks.CYAN_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider purpleConcrete = blockStateModelGenerator.family(Blocks.PURPLE_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider blueConcrete = blockStateModelGenerator.family(Blocks.BLUE_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider brownConcrete = blockStateModelGenerator.family(Blocks.BROWN_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider greenConcrete = blockStateModelGenerator.family(Blocks.GREEN_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider redConcrete = blockStateModelGenerator.family(Blocks.RED_CONCRETE);
        ...
        BlockModelGenerators.BlockFamilyProvider blackConcrete = blockStateModelGenerator.family(Blocks.BLACK_CONCRETE);
